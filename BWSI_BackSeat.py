...
class BackSeat ():
    ...
    def convert_commands (self, rudder_command, engine_command):
        #add function to convert commands to requests
        pass
...
def main():
    ...
    writer = csv.DictWriter(log_file_name, fieldnames = ['Timestamp (UTC)', 'Position', 'Current Heading (deg)', 'Desired Heading (deg)', 'Green Bouys', 'Red Bouys', 'Error'])
    writer.writeheader()
    reader = csv.DictReader(log_file_name)
